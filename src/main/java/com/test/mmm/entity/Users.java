...
public class Users implements Serializable {
    ...
    public Users(int id, String login, String password, String firstname, String lastname, String email, String phone,
            String address1, String country, String state, String zip, String sex, Date registereddt,
            Date lastvisitdt) {
        this.id = id;
        this.login = login;
    ...
    public Users(int id, String login, String password, String firstname, String lastname, String email, String phone,
            String address1, String address2, String country, String state, String zip, String sex, String organization,
            String organaddress, byte[] photo, String notes, Date registereddt, Date lastvisitdt, Set resultses,
            Set importinfos, Set componentses, Set resultshistories, Set viewtemplatesesForUpdatedby,
            Set viewtemplatesesForUserId, Set noteses, Set projectmemberses, Set unitses, Set projectses) {
        this.id = id;
        this.login = login;
        this.password = password;
        this.firstname = firstname;
